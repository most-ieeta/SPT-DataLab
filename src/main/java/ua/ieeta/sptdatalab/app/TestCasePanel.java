...
public class TestCasePanel extends JPanel {
    ...
    //flag to indicate if this is the first(left) panel or the second(right)
    ...
    */
    public TestCasePanel() {
        editPanel = new GeometryEditPanel(this.isSecondPanel);
        try {
            jbInit();
        }
        catch (Exception ex) {
    ...
    public TestCasePanel(boolean isSecondPanel) {
