...
public class TestListPanel extends JPanel {
    ...
    private class TestListCellRenderer extends JLabel implements ListCellRenderer {
        ...
        private String testName(Testable testCase)
        {
          ...
          int testSkey = 1 + SPTDataLabBuilderFrame.instance().getModel().getCases().indexOf(testCase);
    ...
    public TestListPanel(SPTDataLabBuilderFrame testBuilderFrame) {
        this();
    }
        ...
        list.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (list.getSelectedValue() == null)
                    return;
                SPTDataLabBuilderFrame.instance().setCurrentTestCase(
    ...
    public void populateList() {
        listModel.clear();
        for (Iterator i = SPTDataLabBuilderFrame.instance().getModel().getCases().iterator();
            i.hasNext();
            ) {
