...
public enum SimilarityMetricsEnum 
{
	Hausdorff_Distance(1), Jaccard_Index(2);
			
	private int value;    

	private SimilarityMetricsEnum(int value) {
		this.value = value;
	}
	...
	public int get_value() {
        ...
        public static String[] getStatStringList(){
            return new String[]{Hausdorff_Distance.toString(), Jaccard_Index.toString()};
        }
}