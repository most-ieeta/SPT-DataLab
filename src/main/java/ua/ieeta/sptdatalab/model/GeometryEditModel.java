...
import ua.ieeta.sptdatalab.geom.GeometryVertexMover;
import ua.ieeta.sptdatalab.geom.GeometryPointLocater;
...
import ua.ieeta.sptdatalab.geom.AdjacentVertexFinder;
import java.util.*;
...
return testCase.getResult();
    ...
    {
        GeometryCombiner creator = new GeometryCombiner(SPTDataLab.getGeometryFactory());
